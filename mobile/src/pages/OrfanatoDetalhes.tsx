...
interface OrfanatoDetalhesParams {
    id: number;
}
...
export default function OrfanatoDetalhes() {
    const route = useRoute();
    const [orfanato, setOrfanato] = useState<Orfanato>();

    const params = route.params as OrfanatoDetalhesParams;
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <View style={styles.detailsContainer}>
                ...
                <Text style={styles.description}>{orfanato.instructions}</Text>

                <View style={styles.scheduleContainer}>
                    <View style={[styles.scheduleItem, styles.scheduleItemBlue]}>
                        <Feather name="clock" size={40} color="#2AB5D1" />
                        <Text style={[styles.scheduleText, styles.scheduleTextBlue]}>Segunda à Sexta {orfanato.opening_hours}</Text>
                    </View>
